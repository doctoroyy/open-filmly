...
interface SimpleScrapingMonitorProps {
  isVisible: boolean
  onClose: () => void
  onStart: () => void
  onPause: () => void
...
export function SimpleScrapingMonitor({
  isVisible,
  onClose,
  onStart,
  onPause,
  ...
  return (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="bg-background rounded-xl w-full max-w-6xl max-h-[90vh] overflow-hidden shadow-2xl">
        {/* 头部 */}
                  ...
                  <CardContent>
                    <div className="space-y-3">
                      {processingItems.map((item) => (
                        <div
                          key={item.id}
                          className="flex items-center justify-between p-3 bg-blue-50 dark:bg-blue-950/20 rounded-lg transition-all"
                        >
                          <div className="flex items-center gap-3">
            ...
            <TabsContent value="completed" className="space-y-4">
              <div className="max-h-96 overflow-y-auto space-y-2">
                {completedItems.map((item) => (
                  <div
                    key={item.id}
                    className="flex items-center justify-between p-3 bg-green-50 dark:bg-green-950/20 border border-green-200 dark:border-green-800 rounded-lg transition-all"
                  >
                    <div className="flex items-center gap-3">
            ...
            <TabsContent value="failed" className="space-y-4">
              <div className="max-h-96 overflow-y-auto space-y-2">
                {failedItems.map((item) => (
                  <div
                    key={item.id}
                    className="flex items-center justify-between p-3 bg-red-50 dark:bg-red-950/20 border border-red-200 dark:border-red-800 rounded-lg transition-all"
                  >
                    <div className="flex items-center gap-3">
